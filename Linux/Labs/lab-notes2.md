...
## Screenshot
![Challenge Instructions](images/Instructions.png "Instructions")
After launching the Linux terminal with SSH, you log into terminal as EC2-User, and proceed to running commands.

![Bash GNU Nano Window](images/Window.png "Touch Script")
...
![Terminal Output](images/Output.png "Touch Script Output")
